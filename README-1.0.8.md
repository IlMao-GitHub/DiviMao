...
alias dli="~/divi-1.0.8/bin/divi-cli"
alias dividebug="sudo tail -f ~/.divi/debug.log"
alias divistart="~/divi-1.0.8/bin/divid"
alias dividir="cd ~/divi-1.0.8/bin"
...
alias divirefresh="~/divi-1.0.8/bin/divid -reindex"
alias divirescan="~/divi-1.0.8/bin/divid -rescan"
alias ll='ls -la'
```
